...
x13write(val::Union{X13.ao,X13.ls,X13.tc,X13.so}) = "$(nameof(typeof(val)))$(x13write(val.mit))"
x13write(val::Union{X13.aos,X13.lss,X13.rp,X13.qd,X13.qi,X13.tl}) = "$(nameof(typeof(val)))$(x13write(val.mit1))-$(x13write(val.mit2))"
x13write(val::Union{X13.tdstock,X13.tdstock1coef,X13.easter,X13.labor,X13.thank,X13.sceaster,X13.easterstock}) = "$(nameof(typeof(val)))[$(val.n)]"
