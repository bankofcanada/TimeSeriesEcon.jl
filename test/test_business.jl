...
@testset "BDaily" begin
    ...
    @test values(tsbd[end-9:end]) ≈ [1.38, 1.44, 1.42, 1.44, 1.46, 1.47, 1.45, 1.42] nans = true
    @test values(tsbd_shifted[end-9:end]) ≈ [1.38, 1.44, 1.42, 1.44, 1.46, 1.47, 1.45, 1.42] nans = true
    @test values(tsbd_lagged[end-9:end]) ≈ [1.38, 1.44, 1.42, 1.44, 1.46, 1.47, 1.45] nans = true
    @test values(tsbd_diffed[end-9:end]) ≈ [0.06, 0.06, -0.02, 0.02, 0.02, 0.01, -0.02, -0.03] nans = true
    @test values(tsbd_pct[end-9:end]) ≈ [4.55, 4.35, -1.39, 1.41, 1.39, 0.68, -1.36, -2.07] nans = true atol = 0.01
    ...
    @test values(tsbd_lagged3[end-9:end]) ≈ [1.38, 1.44, 1.42, 1.44, 1.46, 1.47, 1.45] nans = true
    @test values(tsbd_diffed3[end-9:end]) ≈ [0.06, 0.06, -0.02, 0.02, 0.02, 0.01, -0.02, -0.03] nans = true
    @test values(tsbd_pct3[end-9:end]) ≈ [4.55, 4.35, -1.39, 1.41, 1.39, 0.68, -1.36, -2.07] nans = true atol = 0.01
    ...
    @test values(tsbd[end-9:end], holidays_map=ontario_map) ≈ [1.38, 1.44, 1.42, 1.44, 1.46, 1.47, 1.45, 1.42] nans = true
